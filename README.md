# Gamelauncher-model-anime4k

Download-only distribution scaffold for the GameLauncher **anime4k** model.

Repository: https://github.com/nekobyran/Gamelauncher-model-anime4k
...
Scaffold metadata and documentation use `MIT`. Distributed Anime4K payloads retain their upstream `MIT` terms. See `THIRD_PARTY_NOTICES.md`.
